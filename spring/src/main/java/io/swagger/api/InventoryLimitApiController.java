...
@Controller
public class InventoryLimitApiController implements InventoryLimitApi {

    private static final Logger log = LoggerFactory.getLogger(InventoryLimitApiController.class);
    ...
    public InventoryLimitApiController(ObjectMapper objectMapper, HttpServletRequest request) {
